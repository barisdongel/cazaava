...
if (isset($_POST['arama'])) {
	...
	$urunsor=$db->prepare("SELECT * FROM urunler_tbl ORDER BY urun_id");
	$urunsor->execute();
	$say=$urunsor->rowCount();
}
	...
	<div class="col-12 col-md-12 col-lg-12">
		<div class="card">
			...
			<div class="card-header bg-primary justify-content-center">
				<td><a href="urunler.php" class="ktgry btn p-3 text-center text-white">TÜM ÜRÜNLER</a></td>
			...
			<form action="../islem.php" method="POST">
				<table class="table table-striped table-md">
					...
					<?php while ($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) {
						...
						?>
						<tr>
							<td class="text-center"><img style="width: 50%;" src="../<?php echo $uruncek['urun_foto']; ?>"></td>
							<td style="width:16%;"><?php echo $uruncek['urun_ad']; ?></td>
							<?php $kategoricek=$kategorisor->fetch(PDO::FETCH_ASSOC); ?>
							<td style="width:16%;"><?php echo $kategoricek['kategori_ad']; ?></td>
							<td><a href="urun-fotogaleri.php?urun_id=<?php echo $uruncek['urun_id'] ?>" class="btn btn-outline-warning"><i class="fa fa-images"></i> Fotoğraf Ekle</a></td>
