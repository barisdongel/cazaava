...
<head>
  ...
  <link rel="stylesheet" href="assets/dropzone/dist/.css">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <img alt="image" src="<?php echo $kullanicicek['kullanici_foto'] ?>" class="user-img-radious-style">
            <span class="d-sm-none d-lg-inline-block"></span></a>
            <div class="dropdown-menu dropdown-menu-right">
              <div class="dropdown-title">Hoşgeldin <?php echo $_SESSION['kullanici_ad'] ?></div>
