			...
			<form action="../islem.php" method="POST" enctype="multipart/form-data">
				...
				<div class="card-body">
					<div class="form-group">
						<div class="form-group">
							<img style="width: 20%;" src="../<?php echo $uruncek['urun_foto'] ?>">
						</div>
						<div class="form-group">
							<label><i class="fa fa-image"></i> Ürün Fotoğrafı</label>
							<input style="height: 50px;" type="file" name="urun_foto" class="form-control" value="../<?php echo $uruncek['urun_foto'] ?>">
						</div>
						<label><i class="fa fa-heading"></i> Ürün Ad</label>
						<input type="text" name="urun_ad" class="form-control" value="<?php echo $uruncek['urun_ad'] ?>">
					</div>
					<div class="form-group">
						<label><i class="fa fa-file"></i> Ürün Açıklaması</label>
						<input type="text" name="urun_aciklama" class="form-control" value="<?php echo $uruncek['urun_aciklama'] ?>">
					</div>
					<div class="form-group">
						<label><i class="fa fa-list"></i> Ürün Özellikleri</label>
						<textarea name="urun_ozellik" type="submit" id="ckeditor1"><?php echo $uruncek['urun_ozellik'] ?></textarea>
					</div>
					<div class="form-group">
